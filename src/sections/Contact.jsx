const Contact = () => {
  return (
    <section id="contact" className="py-20 bg-gray-100 dark:bg-gray-900 text-center">
      <h2 className="text-3xl font-semibold mb-6 text-gray-900 dark:text-white">Entre em Contato</h2>
      <p className="text-gray-600 dark:text-gray-300 mb-4">victoradauto@yahoo.com.br</p>
      <a
